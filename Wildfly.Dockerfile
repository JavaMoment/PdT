...
MAINTAINER "Gonzalo Ruiz" "gonzalo.ruiz@estudiantes.utec.edu.uy"
...
RUN /bin/sh -c '$JBOSS_HOME/bin/standalone.sh &' && \
  ...
  $JBOSS_HOME/bin/jboss-cli.sh --connect --command="data-source add --name=PDT_DS --jndi-name=java:/PDT_DS --driver-name=ojdbc11.jar --connection-url=jdbc:oracle:thin:@172.17.0.1:1521:xe --user-name=c##proyecto --password=proyecto" && \

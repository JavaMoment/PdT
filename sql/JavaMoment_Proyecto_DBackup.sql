--------------------------------------------------------
-- Archivo creado  - sábado-junio-10-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##PROYECTO"."LOCALI_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 11 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into C##PROYECTO.USUARIOS (NOMBRE_USUARIO,NOMBRE1,NOMBRE2,APELLIDO1,APELLIDO2,FEC_NAC,GENERO,ID_DEPARTAMENTO,ID_LOCALIDAD,ID_ITR,MAIL,CONTRASENIA,TELEFONO,DOCUMENTO,ACTIVO) values ('gonzalo.ruiz','Gonzalo',null,'Ruiz','Alvez',to_date('03/05/02','DD/MM/RR'),'O','1','9','1','gonzalo@mail.com','gOnzal04222#',null,'53574721','0');
Insert into C##PROYECTO.USUARIOS (NOMBRE_USUARIO,NOMBRE1,NOMBRE2,APELLIDO1,APELLIDO2,FEC_NAC,GENERO,ID_DEPARTAMENTO,ID_LOCALIDAD,ID_ITR,MAIL,CONTRASENIA,TELEFONO,DOCUMENTO,ACTIVO) values ('gonza.ruiz','Gonza',null,'Ruiz','Alvez',to_date('03/05/02','DD/MM/RR'),'M','2','7','4','gonza@mail.com','1234','094364212','53689538','0');
--------------------------------------------------------

--------------------------------------------------------
--  File created - viernes-julio-07-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##PROYECTO"."ESTUD_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence EVENT_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##PROYECTO"."EVENT_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 10 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
Insert into C##PROYECTO.DEPARTAMENTOS (ID_DEPARTAMENTO,NOMBRE,ID_ITR) values (16,'Tacuarembó',3);
REM INSERTING into C##PROYECTO.ESTADOS
SET DEFINE OFF;
Insert into C##PROYECTO.ESTADOS (ID_ESTADO,NOMBRE,ACTIVO) values (2,'FUTURO',1);
Insert into C##PROYECTO.ESTADOS (ID_ESTADO,NOMBRE,ACTIVO) values (6,'FINALIZADO',1);
Insert into C##PROYECTO.ESTADOS (ID_ESTADO,NOMBRE,ACTIVO) values (4,'CORRIENTE',1);
REM INSERTING into C##PROYECTO.ESTUDIANTES
SET DEFINE OFF;
Insert into C##PROYECTO.ESTUDIANTES (ID_ESTUDIANTE,NOMBRE_USUARIO,GENERACION) values (2,'gonza.ruiz','2002');
Insert into C##PROYECTO.ESTUDIANTES (ID_ESTUDIANTE,NOMBRE_USUARIO,GENERACION) values (1,'gianluca.battistin','2003');
...
SET DEFINE OFF;
Insert into C##PROYECTO.EVENTOS (ID_EVENTO,FECHA_HORA_INICIO,FECHA_HORA_FINAL,TITULO,LOCALIZACION,TIPO_EVENTO,ID_ITR,ID_ESTADO,ID_MODALIDAD,ACTIVO) values (6,to_date('04-JUL-23 00:00:00','DD-MON-RR HH24:MI:SS'),to_date('05-JUL-23 00:00:00','DD-MON-RR HH24:MI:SS'),'pruebas','aaaaaaaaaaaaa','JORNADA_PRESENCIAL',1,2,2,1);
Insert into C##PROYECTO.EVENTOS (ID_EVENTO,FECHA_HORA_INICIO,FECHA_HORA_FINAL,TITULO,LOCALIZACION,TIPO_EVENTO,ID_ITR,ID_ESTADO,ID_MODALIDAD,ACTIVO) values (7,to_date('04-JUL-23 00:00:00','DD-MON-RR HH24:MI:SS'),to_date('05-JUL-23 00:00:00','DD-MON-RR HH24:MI:SS'),'pruebas2','aaaaaaaaaaaaa','JORNADA_PRESENCIAL',1,2,2,1);
Insert into C##PROYECTO.EVENTOS (ID_EVENTO,FECHA_HORA_INICIO,FECHA_HORA_FINAL,TITULO,LOCALIZACION,TIPO_EVENTO,ID_ITR,ID_ESTADO,ID_MODALIDAD,ACTIVO) values (8,to_date('04-JUL-23 00:00:00','DD-MON-RR HH24:MI:SS'),to_date('05-JUL-23 00:00:00','DD-MON-RR HH24:MI:SS'),'pruebas3','aaaaaaaaaaaaa','JORNADA_PRESENCIAL',1,2,2,0);
Insert into C##PROYECTO.EVENTOS (ID_EVENTO,FECHA_HORA_INICIO,FECHA_HORA_FINAL,TITULO,LOCALIZACION,TIPO_EVENTO,ID_ITR,ID_ESTADO,ID_MODALIDAD,ACTIVO) values (9,to_date('04-JUL-23 00:00:00','DD-MON-RR HH24:MI:SS'),to_date('05-JUL-23 00:00:00','DD-MON-RR HH24:MI:SS'),'pruebas4','aaaaaaaaaaaaa','JORNADA_PRESENCIAL',1,2,2,1);
...
Insert into C##PROYECTO.MODALIDADES (ID_MODALIDAD,NOMBRE,ACTIVO) values (4,'SEMIPRESENCIAL',1);
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##PROYECTO"."EVENTOS" ADD CONSTRAINT "FK_EVENTOS_ID_MODALIDAD" FOREIGN KEY ("ID_MODALIDAD")

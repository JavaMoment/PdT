...
SET DEFINE OFF;
Insert into C##PROYECTO.ESTUDIANTE_EVENTO (ID_ESTUDIANTE,ID_EVENTO,CALIFICACION,ASISTENCIA) values (1,6,0,'PENDIENTE');
Insert into C##PROYECTO.ESTUDIANTE_EVENTO (ID_ESTUDIANTE,ID_EVENTO,CALIFICACION,ASISTENCIA) values (2,6,0,'PENDIENTE');
Insert into C##PROYECTO.ESTUDIANTE_EVENTO (ID_ESTUDIANTE,ID_EVENTO,CALIFICACION,ASISTENCIA) values (1,9,0,'PENDIENTE');

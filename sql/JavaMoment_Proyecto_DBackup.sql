...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##PROYECTO"."ESTUD_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 27 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##PROYECTO"."TUTORES_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 14 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
Insert into C##PROYECTO.ANALISTAS (ID_ANALISTA,NOMBRE_USUARIO) values (21,'rodrigo.romano');
...
SET DEFINE OFF;
Insert into C##PROYECTO.ESTUDIANTES (ID_ESTUDIANTE,NOMBRE_USUARIO,GENERACION) values (24,'gluca','2019');
Insert into C##PROYECTO.ESTUDIANTES (ID_ESTUDIANTE,NOMBRE_USUARIO,GENERACION) values (26,'gonza.ruiz','2018');
Insert into C##PROYECTO.ESTUDIANTES (ID_ESTUDIANTE,NOMBRE_USUARIO,GENERACION) values (6,'romi.caubarrere','2022');
...
SET DEFINE OFF;
Insert into C##PROYECTO.TUTORES (ID_TUTOR,NOMBRE_USUARIO,TIPO,ID_AREA) values (2,'gon.ruiz','ENCARGADO',1);
...
Insert into C##PROYECTO.USUARIOS (NOMBRE_USUARIO,NOMBRE1,NOMBRE2,APELLIDO1,APELLIDO2,FEC_NAC,GENERO,ID_DEPARTAMENTO,ID_LOCALIDAD,ID_ITR,MAIL_INSTITUCIONAL,CONTRASENIA,TELEFONO,DOCUMENTO,ACTIVO,MAIL_PERSONAL) values ('p.perez','Pedro',null,'Perez','Postin',to_date('14-AUG-89','DD-MON-RR'),'M',15,51,1,'pperez@analistas.utec.edu.uy','Pedrop3#',null,'00000000',1,'pperez@gmail.com');
Insert into C##PROYECTO.USUARIOS (NOMBRE_USUARIO,NOMBRE1,NOMBRE2,APELLIDO1,APELLIDO2,FEC_NAC,GENERO,ID_DEPARTAMENTO,ID_LOCALIDAD,ID_ITR,MAIL_INSTITUCIONAL,CONTRASENIA,TELEFONO,DOCUMENTO,ACTIVO,MAIL_PERSONAL) values ('gluca','Gian','Luca','Battistin','Battistin',to_date('02-FEB-03','DD-MON-RR'),'M',18,61,2,'gluca@tutores.utec.edu.uy','Gianluc4#',null,'99999999',0,'gian.luca@gmail.com');
Insert into C##PROYECTO.USUARIOS (NOMBRE_USUARIO,NOMBRE1,NOMBRE2,APELLIDO1,APELLIDO2,FEC_NAC,GENERO,ID_DEPARTAMENTO,ID_LOCALIDAD,ID_ITR,MAIL_INSTITUCIONAL,CONTRASENIA,TELEFONO,DOCUMENTO,ACTIVO,MAIL_PERSONAL) values ('gonza.ruiz','Gonzalo','Lalo','Rushmore','Roshi',to_date('03-MAY-02','DD-MON-RR'),'M',19,64,6,'gonza.ruiz@estudiantes.utec.edu.uy','G0nzal0#','094475502','53689538',1,'gonza.ruiz@gmail.com');
Insert into C##PROYECTO.USUARIOS (NOMBRE_USUARIO,NOMBRE1,NOMBRE2,APELLIDO1,APELLIDO2,FEC_NAC,GENERO,ID_DEPARTAMENTO,ID_LOCALIDAD,ID_ITR,MAIL_INSTITUCIONAL,CONTRASENIA,TELEFONO,DOCUMENTO,ACTIVO,MAIL_PERSONAL) values ('gon.ruiz','Gonzalo',null,'Ruiz','Alvez',to_date('03-MAY-00','DD-MON-RR'),'M',12,42,3,'gon.ruiz@tutores.utec.edu.uy','Gonzal0#','094475502','53574721',1,'gonzalo.ruiz@gmail.com');
Insert into C##PROYECTO.USUARIOS (NOMBRE_USUARIO,NOMBRE1,NOMBRE2,APELLIDO1,APELLIDO2,FEC_NAC,GENERO,ID_DEPARTAMENTO,ID_LOCALIDAD,ID_ITR,MAIL_INSTITUCIONAL,CONTRASENIA,TELEFONO,DOCUMENTO,ACTIVO,MAIL_PERSONAL) values ('romi.caubarrere','Romina',null,'Caubarrere','Caubarrere',to_date('01-JUL-03','DD-MON-RR'),'F',6,23,3,'romi.caubarrere@estudiantes.utec.edu.uy','Caubarrer3#',null,'43662928',1,'romi.cauba@gmail.com');
--------------------------------------------------------

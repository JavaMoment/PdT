...
--------------------------------------------------------
  ...
  CREATE TABLE "C##PROYECTO"."EVENTOS" 
   (	"ID_EVENTO" NUMBER(*,0), 
	...
	"TIPO_EVENTO" VARCHAR2(100 BYTE), 
	"MODALIDAD" VARCHAR2(100 BYTE), 
	"ID_ITR" NUMBER(*,0), 
...
SET DEFINE OFF;
Insert into C##PROYECTO.AREAS (ID_AREA,NOMBRE,DESCRIPCION) values (1,'Programación','Area encargada de las materias referentes al desarrollo de sistemas informaticos');
...
Insert into C##PROYECTO.DEPARTAMENTOS (ID_DEPARTAMENTO,NOMBRE,ID_ITR) values (9,'Paysandú',1);
Insert into C##PROYECTO.DEPARTAMENTOS (ID_DEPARTAMENTO,NOMBRE,ID_ITR) values (10,'Río Negro',1);
...
Insert into C##PROYECTO.DEPARTAMENTOS (ID_DEPARTAMENTO,NOMBRE,ID_ITR) values (13,'San José',2);
Insert into C##PROYECTO.DEPARTAMENTOS (ID_DEPARTAMENTO,NOMBRE,ID_ITR) values (14,'Mercedes',1);
Insert into C##PROYECTO.DEPARTAMENTOS (ID_DEPARTAMENTO,NOMBRE,ID_ITR) values (15,'Tacuarembó',3);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (2,'Santa Lucía',2);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (6,'Atlántida',2);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (9,'San Ramón',2);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (12,'Bella Unión',1);
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (13,'Tomás Gomensoro',1);
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (14,'Melo',3);
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (15,'Río Branco',3);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (21,'Sarandí del Yí',5);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (25,'Juan José Castro',6);
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (26,'Florida',7);
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (27,'Sarandí Grande',7);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (32,'Paysandú',9);
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (33,'Guichón',9);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (37,'Nuevo Berlín',10);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (43,'Daymán',12);
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (44,'San José de Mayo',13);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (50,'Tacuarembó',15);
...
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (54,'José Pedro Varela',16);
Insert into C##PROYECTO.LOCALIDADES (ID_LOCALIDAD,NOMBRE,ID_DEPARTAMENTO) values (55,'Solís de Mataojo',16);
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##PROYECTO"."EVENTOS" MODIFY ("TIPO_EVENTO" NOT NULL ENABLE);
  ALTER TABLE "C##PROYECTO"."EVENTOS" MODIFY ("MODALIDAD" NOT NULL ENABLE);
